...
params['init_learning_rate'] = 15e-3 * global_batch_size / 8
params['warmup_learning_rate'] = 15e-4 * global_batch_size / 8
params['warmup_steps'] = steps_per_epoch
params['learning_rate_steps'] = [steps_per_epoch * 9, steps_per_epoch * 11]
params['learning_rate_levels'] = [15e-4 * global_batch_size / 8, 15e-5 * global_batch_size / 8]
params['momentum'] = 0.9
